...
*/
function ilot_preprocess_views_view_unformatted(&$variables) {
  $view = $variables['view'];
...
function ilot_preprocess_node(&$var) {
//    dpm($var["type"]);
...
function ilot_preprocess_page(&$variables, $hook) {  // Add theme suggestion for all content types
